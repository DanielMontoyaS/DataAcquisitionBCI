...
def mainlch():
    ...
    im = cv2.imread('C:/Users/Daniel Montoya/Documents/SistemasEmbebidos/OpenbciPrueba/LCH.jpg')
    ...
    while True:
        ...
        if len(DatosLCH) == 500:
            ...
            df.to_csv("C:/Users/Daniel Montoya/Documents/SistemasEmbebidos/OpenbciPrueba/Recoleccion/" + name + "_" +
                      str(lch) + '.csv')
            DatosLCH.clear()
            break
...
def mainrch():
    ...
    im = cv2.imread('C:/Users/Daniel Montoya/Documents/SistemasEmbebidos/OpenbciPrueba/RCH.jpg')
    cv2.namedWindow('Image', cv2.WINDOW_NORMAL)
    cv2.setWindowProperty('Image', cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
    cv2.imshow("Image", im)
    cv2.waitKey(500)
...
def mainldf():
    ...
    im = cv2.imread('C:/Users/Daniel Montoya/Documents/SistemasEmbebidos/OpenbciPrueba/LDF.jpg')
    cv2.namedWindow('Image', cv2.WINDOW_NORMAL)
    cv2.setWindowProperty('Image', cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
    cv2.imshow("Image", im)
    cv2.waitKey(500)
...
def mainlpf():
    ...
    im = cv2.imread('C:/Users/Daniel Montoya/Documents/SistemasEmbebidos/OpenbciPrueba/LPF.jpg')
    cv2.namedWindow('Image', cv2.WINDOW_NORMAL)
    cv2.setWindowProperty('Image', cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
    cv2.imshow("Image", im)
    cv2.waitKey(500)
...
def mainrdf():
    ...
    im = cv2.imread('C:/Users/Daniel Montoya/Documents/SistemasEmbebidos/OpenbciPrueba/RDF.jpg')
    cv2.namedWindow('Image', cv2.WINDOW_NORMAL)
    cv2.setWindowProperty('Image', cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
    cv2.imshow("Image", im)
    cv2.waitKey(500)
...
def mainrpf():
    ...
    im = cv2.imread('C:/Users/Daniel Montoya/Documents/SistemasEmbebidos/OpenbciPrueba/RPF.jpg')
    cv2.namedWindow('Image', cv2.WINDOW_NORMAL)
    cv2.setWindowProperty('Image', cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
    cv2.imshow("Image", im)
    cv2.waitKey(500)
...
def mainbeo():
    ...
    im = cv2.imread('C:/Users/Daniel Montoya/Documents/SistemasEmbebidos/OpenbciPrueba/Baseline.jpg')
    cv2.namedWindow('Image', cv2.WINDOW_NORMAL)
    cv2.setWindowProperty('Image', cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
    cv2.imshow("Image", im)
    cv2.waitKey(500)
...
def descanso():
    img = cv2.imread('C:/Users/Daniel Montoya/Documents/SistemasEmbebidos/OpenbciPrueba/Descanso.jpg')
    cv2.namedWindow('Image', cv2.WINDOW_NORMAL)
    cv2.setWindowProperty('Image', cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
